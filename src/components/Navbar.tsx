...
export default function Navbar({ activeSection, theme, toggleTheme }: NavbarProps) {
  ...
  const downloadMockResume = () => {
    // Generate a simple text file or prompt indicating download
    const resumeText = `DIVYANSHI KATIYAR - RESUME
Computer Science Student & Learner Full Stack Developer
Email: divi.katiyar0435@gmail.com
Location: India

SUMMARY:
A motivated B.Tech Computer Science student currently learning Full Stack Web Development. I enjoy turning ideas into responsive web applications and continuously improving my programming skills.
...
SKILLS:
- Frontend: HTML5, CSS3, JavaScript, React, TypeScript, Tailwind CSS, Framer Motion
- Backend: Node.js, Express, PostgreSQL / Relational concepts, REST APIs
- Tools: Git, GitHub, VS Code

PROJECTS:
1. Personal Portfolio Website
2. Responsive Task Tracker App
`;
    const blob = new Blob([resumeText], { type: 'text/plain' });
    const url = URL.createObjectURL(blob);
    const link = document.createElement('a');
    link.href = url;
    link.download = 'Divyanshi_Katiyar_Resume.txt';
